...
// Handlers
const getAllBlogs = async (req: any , reply: any) => {
    return blogs
}

const getBlog = async (req: any , reply: any) => {
    const id = Number(req.params.id) // blog ID
    const blog = blogs.find(blog => blog.id === id)
    return blog
}

const addBlog = async (req: any , reply: any) => {
...
const updateBlog = async (req: any , reply: any) => {
...
const deleteBlog = async (req: any , reply: any) => {
    const id = Number(req.params.id)
